import { c as createComponent, r as renderTemplate, a as renderComponent, m as maybeRenderHead } from '../chunks/astro/server_C4v43ugf.mjs';
import 'kleur/colors';
import { $ as $$Layout, a as $$SectionContainer, b as $$Badge, c as $$SocialPill, d as $$LinkedIn } from '../chunks/Layout_C3gt0wGN.mjs';
...
LinkedIn
` })} </div> </article> ` })} ` })}`;
}, "/home/asus-fedora/my_apps/astro/porfolio.dev/src/pages/components.astro", void 0);

const $$file = "/home/asus-fedora/my_apps/astro/porfolio.dev/src/pages/components.astro";
