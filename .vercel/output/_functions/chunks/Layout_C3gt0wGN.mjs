import { c as createComponent, r as renderTemplate, m as maybeRenderHead, f as renderSlot, e as createAstro, b as addAttribute, s as spreadAttributes, g as createTransitionScope, a as renderComponent, h as renderScript, i as renderHead } from './astro/server_C4v43ugf.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                              */
...
}, "/home/asus-fedora/my_apps/astro/porfolio.dev/src/components/Badge.astro", void 0);
...
}, "/home/asus-fedora/my_apps/astro/porfolio.dev/src/components/SectionContainer.astro", void 0);
...
}, "/home/asus-fedora/my_apps/astro/porfolio.dev/src/components/SocialPill.astro", void 0);
...
}, "/home/asus-fedora/my_apps/astro/porfolio.dev/src/components/icons/LinkedIn.astro", void 0);
...
}, "/home/asus-fedora/my_apps/astro/porfolio.dev/src/components/icons/Sun.astro", void 0);
...
}, "/home/asus-fedora/my_apps/astro/porfolio.dev/src/components/icons/Moon.astro", void 0);
...
}, "/home/asus-fedora/my_apps/astro/porfolio.dev/src/components/icons/System.astro", void 0);
...
}, "/home/asus-fedora/my_apps/astro/porfolio.dev/src/components/ThemeToggle.astro", "self");
...
const $$Header = createComponent(($$result, $$props, $$slots) => {
  const navItems = [
    ...
    },
    {
      title: "Contacto",
      label: "contacto",
      url: "mailto:davot098@gmail.com"
    }
  ];
  return renderTemplate`${maybeRenderHead()}<header class="fixed top-0 z-10 flex items-center justify-center w-full mx-auto mt-2"> <nav class="flex px-3 text-sm font-medium rounded-full text-gray-600 dark:text-gray-200 justify-center items-center dark:bg-gray-800/90 bg-white/50 shadow-lg backdrop-blur ring-1 ring-white/10"> ${navItems.map((link) => renderTemplate`<a class="relative block px-2 py-2 transition hover:text-blue-500 dark:hover:text-blue-500"${addAttribute(link.label, "aria-label")}${addAttribute(link.url, "href")}> ${link.title} </a>`)} ${renderComponent($$result, "ThemeToggle", $$ThemeToggle, {})} </nav> </header> ${renderScript($$result, "/home/asus-fedora/my_apps/astro/porfolio.dev/src/components/Header.astro?astro&type=script&index=0&lang.ts")}`;
}, "/home/asus-fedora/my_apps/astro/porfolio.dev/src/components/Header.astro", void 0);

const $$Footer = createComponent(($$result, $$props, $$slots) => {
  const currentYear = (/* @__PURE__ */ new Date()).getFullYear();
  return renderTemplate`${maybeRenderHead()}<footer class="opacity-80 m-4 min-[375px]:pl-4 md:pl-0 mt-16 w-full mx-auto container lg:max-w-4xl md:max-w-2xl mb-10 flex justify-center"> <div class="rounded-lg w-full max-w-screen-xl mx-auto md:flex md:items-center md:justify-between py-4"> <span class="text-sm sm:text-center text-zinc-800/90 dark:text-zinc-200/90">© ${currentYear} <a href="https://midu.dev/" class="hover:underline">David Alexander</a>. Derechos reservados
</span> <span class="text-sm sm:text-center text-zinc-800/90 dark:text-zinc-200/90">Inspirado en:
<a href="https://github.com/midudev/porfolio.dev" class="hover:underline">portafolio.dev</a> </span> <ul class="flex flex-wrap items-center mt-3 text-sm font-medium dark:text-white/90 sm:mt-0"> <li> <a href="/#sobre-mi" class="hover:underline me-4 md:me-6">Sobre mí</a> </li> <li> <a id="contacto" href="mailto:davot098@gmail.com" class="hover:underline">Contacto</a> </li> </ul> </div> </footer>`;
}, "/home/asus-fedora/my_apps/astro/porfolio.dev/src/components/Footer.astro", void 0);
...
const $$ClientRouter = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<meta name="astro-view-transitions-enabled" content="true"><meta name="astro-view-transitions-fallback"${addAttribute(fallback, "content")}>${renderScript($$result, "/home/asus-fedora/my_apps/astro/porfolio.dev/node_modules/astro/components/ClientRouter.astro?astro&type=script&index=0&lang.ts")}`;
}, "/home/asus-fedora/my_apps/astro/porfolio.dev/node_modules/astro/components/ClientRouter.astro", void 0);
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="es"> <head><meta charset="UTF-8"><meta name="description"${addAttribute(description, "content")}><meta name="viewport" content="width=device-width"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><meta name="generator"${addAttribute(Astro2.generator, "content")}><title>${title}</title>${renderComponent($$result, "ClientRouter", $$ClientRouter, {})}${renderHead()}</head> <body class="relative text-black dark:text-white"> <div class="inset-0 -z-10 h-screen fixed w-full items-center px-5 py-24 bg-gray-50 dark:bg-gray-950
    ...
    >
    </div> --> ${renderComponent($$result, "Header", $$Header, {})} ${renderSlot($$result, $$slots["default"])} ${renderComponent($$result, "Footer", $$Footer, {})}  </body> </html>`;
}, "/home/asus-fedora/my_apps/astro/porfolio.dev/src/layouts/Layout.astro", void 0);

export { $$Layout as $, $$SectionContainer as a, $$Badge as b, $$SocialPill as c, $$LinkedIn as d };
